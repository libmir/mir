...
$(BOOKTABLE ,
    ...
    $(LEADINGROW Level 1)
    $(TR
        $(TDNW $(LINK2 mir_glas_dot.html, mir.glas.dot))
        $(TD dot product)
    )
    $(LEADINGROW Level 2)
    $(TR
        $(TDNW $(LINK2 mir_glas_gemv.html, mir.glas.gemv))
        $(TD matrix-vector multiplication)
    )
    $(LEADINGROW Level 3)
    $(TR
...
public import mir.glas.dot;
public import mir.glas.gemv;
