...
unittest
{
    ...
    Tuple!(double[], double)[] tests = [
        ...
        tuple([-2.^^970, M, M, -0X0.0000000000001P * 2.^^-1022], double.max),
        tuple([M, M, -2.^^970, 0X0.0000000000001P * 2.^^-1022], double.infinity),
        tuple([-M, 2.^^971, -M], -double.max),
        tuple([-M, -M, 2.^^970], -double.infinity),
        tuple([-M, -M, 2.^^970, 0X0.0000000000001P * 2.^^-1022], -double.max),
        tuple([-0X0.0000000000001P * 2.^^-1022, -M, -M, 2.^^970], -double.infinity),
